...
- JSON: `schema_type=NeutralIpcRecord.CONTENT_JSON` (default)
- MsgPack: `schema_type=NeutralIpcRecord.CONTENT_MSGPACK`
...
# Create an instance of NeutralTemplate (JSON format)
...
```python
import msgpack  # Required for msgpack serialization
import os  # Required to determine the path of the .ntpl template
import sys
...
# Create an instance of NeutralTemplate (MsgPack format)
ipc_template = NeutralIpcTemplate(template, schema, NeutralIpcRecord.CONTENT_PATH, NeutralIpcRecord.CONTENT_MSGPACK)
